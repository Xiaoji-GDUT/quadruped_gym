...
public:
    ...
    void Enter() override
    {
        std::cout << LOGGER::NOTE << "Entered passive mode. Press '0' to switch to RLFSMStateGetUp." << std::endl;
    }
    ...
    {
        if (rl.control.current_key == Input::Keyboard::Num0)
        {
...
public:
    ...
    std::string CheckChange() override
    {
        if (rl.control.current_key == Input::Keyboard::P)
        {
            return "RLFSMStatePassive";
        }
        if (percent_getup >= 1.0f)
        {
            if (rl.control.current_key == Input::Keyboard::Num1)
            {
                return "RLFSMStateRLLocomotion";
            }
            else if (rl.control.current_key == Input::Keyboard::Num9)
            {
...
public:
    ...
    std::string CheckChange() override
    {
        if (rl.control.current_key == Input::Keyboard::P || percent_getdown >= 1.0f)
        {
            return "RLFSMStatePassive";
        }
        else if (rl.control.current_key == Input::Keyboard::Num0)
        {
            return "RLFSMStateGetUp";
        }
        return state_name_;
...
public:
    ...
    void Enter() override
    {
        ...
        rl.config_name = "walk_these_ways";
    ...
    std::string CheckChange() override
    {
        ...
        else if (rl.control.current_key == Input::Keyboard::Num1)
        {
            return "RLFSMStateRLLocomotion";
        }
        return state_name_;
