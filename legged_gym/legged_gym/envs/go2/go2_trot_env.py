...
class Go2TrotRobot( LeggedRobot ):
    cfg: Go2TrotCfg
    ...
    def reset_idx(self, env_ids):
        ...
        # self._reset_latency_buffers(env_ids) #TODO
        # fill extras
        self.extras['episode'] = {}
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[:3] = noise_scales.ang_vel * self.obs_scales.ang_vel  # base_ang_vel
        noise_vec[3:5] = 0.  # sin_pos, cos_pos (phase)
        noise_vec[5:8] = 0.  # commands (lin_vel_x, lin_vel_y, ang_vel_yaw)
        noise_vec[8:20] = noise_scales.dof_pos * self.obs_scales.dof_pos  # dof_pos
        noise_vec[20:32] = noise_scales.dof_vel * self.obs_scales.dof_vel  # dof_vel
        noise_vec[32:35] = noise_scales.quat * self.obs_scales.quat  # base_euler_xyz
        noise_vec[35:47] = 0.  # actions
    ...
    def _init_buffers(self):
        ...
        #TODO add obs_history latency_buffer
