...
class Go2StairsRobot( LeggedRobot ):
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[6:18] = noise_scales.dof_pos * self.obs_scales.dof_pos  # dof_pos
        noise_vec[18:30] = noise_scales.dof_vel * self.obs_scales.dof_vel  # dof_vel
        noise_vec[30:33] = noise_scales.quat * self.obs_scales.quat  # base_euler_xyz
        noise_vec[33:45] = 0.  # actions
        noise_vec[45:57] = 0.  # last_actions
